  ...
  <el-dialog
    ...
    <el-form :model="dataForm" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      <el-form-item label="作业名称" prop="jobName">
        <el-input v-model="dataForm.jobName" disabled="true"></el-input>
      </el-form-item>
      <el-form-item label="作业类型" prop="jobType" disabled>
        <el-input v-model="dataForm.jobType" disabled="true"></el-input>
      </el-form-item>
      <el-form-item label="作业实现类" prop="jobClass" disabled>
        <el-input v-model="dataForm.jobClass" disabled="true"></el-input>
      </el-form-item>
